...
<head>
    ...
    <title> Gallery - The Foodie </title>
    ...
    <div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav-list navbar-nav">
                            ...
                            <li class="active nav-item"><a class="nav-link" href="./gallery.php">GALLERY</a></li>
        ...
        <div class="gallery-pics">
            <div class="images-rows">
                <img class="gallery-imgs" src="../img/gallery/a.jpg" alt="">
                <img class="gallery-imgs" src="../img/gallery/b.jpg" alt="">
                <img class="gallery-imgs" src="../img/gallery/c.jpg" alt="">
                <img class="gallery-imgs" src="../img/gallery/d.jpg" alt="">
            </div>
            <div class="images-rows">
                <img class="gallery-imgs" src="../img/gallery/e.jpg" alt="">
                <img class="gallery-imgs" src="../img/gallery/f.jpg" alt="">
                <img class="gallery-imgs" src="../img/gallery/g.jpg" alt="">
                <img class="gallery-imgs" src="../img/gallery/h.jpg" alt="">
            </div>
